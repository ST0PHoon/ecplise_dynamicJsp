...
<body>
	...
	if (reLevelPlus.equals("1")) {	// 댓글은 무조건 제일 아래 추가
		...
		sqlReCnt = "select ifnull((select (max(reCnt) + 1) from boardComment as b where reGroupId = " + id + "), (select reCnt + 1 from boardComment as a where id = "+ id +")) FROM boardComment";
	} else { // 중간 댓글인 경우
